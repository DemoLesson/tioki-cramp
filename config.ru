require './application'
TiokiCramp::Application.initialize!

# Development middlewares
if TiokiCramp::Application.env == 'development'
  ...
  use Rack::Static, :urls => ["/javascripts"], :root => TiokiCramp::Application.root(:public)
end
...
#
run TiokiCramp::Application.routes
